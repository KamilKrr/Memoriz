<section class="section teammembers container has-text-centered">
    <h3 class="title is-3">Memoriz Team</h3>
    <div class="columns">
        <div class="column">
        ...
        <div class="column">
            ...
            <div>
                Projektleiter stv., Front-End Developer
            </div>
        </div>
        <div class="column">
        ...
        <div class="column">
            ...
            <div>
                Projektmitarbeiter, Marketing Experte
            </div>
        </div>
    </div>
</section>